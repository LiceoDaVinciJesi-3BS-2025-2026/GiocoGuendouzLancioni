...
MENU_MUSIC_FILE = "C:/Users/ready/Documents/GitHub/GiocoGuendouzLancioni/GiocoGuendouzLancioni/src/giocoguendouzlancioni/the_mountain-space-133254.mp3"
# Stringa con il percorso completo del file musicale di gioco.
GAME_MUSIC_FILE = "C:/Users/ready/Documents/GitHub/GiocoGuendouzLancioni/GiocoGuendouzLancioni/src/giocoguendouzlancioni/momotmusic-speed-of-light-447363.mp3"
...
if os.path.exists("C:/Users/ready/Documents/GitHub/GiocoGuendouzLancioni/GiocoGuendouzLancioni/src/giocoguendouzlancioni/ES_User Interface, Click, Pop Up, Alert Tones - Epidemic Sound - 0813-1088.wav"):
    # Prova a caricare il suono.
    try:
        # Assegna il suono caricato alla variabile globale.
        click_sound = pygame.mixer.Sound("C:/Users/ready/Documents/GitHub/GiocoGuendouzLancioni/GiocoGuendouzLancioni/src/giocoguendouzlancioni/ES_User Interface, Click, Pop Up, Alert Tones - Epidemic Sound - 0813-1088.wav")
...
bg_full_path = "C:/Users/s14685928/Documents/GitHub/GiocoGuendouzLancioni/src/giocoguendouzlancioni/background.jpg"
...
razzo = load("C:/Users/ready/Documents/GitHub/GiocoGuendouzLancioni/GiocoGuendouzLancioni/src/giocoguendouzlancioni/razzo.png")
...
if boost_power_img: boost_power_img = pygame.transform.scale(boost_power_img, (50, 50))
# Se l'immagine boost vita esiste, la ridimensiona.
if boost_health_img: boost_health_img = pygame.transform.scale(boost_health_img, (50, 50))
# Se l'immagine boost velocità esiste, la ridimensiona.
if boost_speed_img: boost_speed_img = pygame.transform.scale(boost_speed_img, (50, 50))
# Se l'immagine boost invincibilità esiste, la ridimensiona.
if boost_invincibility_img: boost_invincibility_img = pygame.transform.scale(boost_invincibility_img, (50, 50))
...
missile_img = load("C:/Users/ready/Documents/GitHub/GiocoGuendouzLancioni/GiocoGuendouzLancioni/src/giocoguendouzlancioni/missile.png")
# Se caricata.
if missile_img:
...
boss_image_file = "C:/Users/ready/Documents/GitHub/GiocoGuendouzLancioni/GiocoGuendouzLancioni/src/giocoguendouzlancioni/boss.png"
...
def show_menu():
    ...
    razzo_menu = load("C:/Users/ready/Documents/GitHub/GiocoGuendouzLancioni/GiocoGuendouzLancioni/src/giocoguendouzlancioni/razzo.png")
    # Se caricata.
    if razzo_menu:
        # Scala l'immagine.
...
def run_game():
    ...
    while running:
        ...
        if keys[pygame.K_SPACE] and current_time - player['last_shot'] > player['fire_rate']:
            ...
            bullets.append(make_bullet(player['x'] + player['width'], player['y'] + player['height'] // 2, player['power']))
        # Spawn.
        ...
        for e in enemies[:]:
            ...
            if current_time - e['last_shot'] > e['shoot_delay']:
                ...
                enemy_bullets.append(make_enemy_bullet(e['x'], e['y'] + e['height'] // 2))
            if e['x'] < -e['width']:
                enemies.remove(e)
        ...
        if boss:
            ...
            if not boss['entering'] and current_time - boss['last_shot'] > boss['shoot_delay']:
                ...
                boss_missiles.append(make_boss_missile(boss['x'], boss['y'] + boss['height']//2, player_rect, boss['missile_speed'], boss['damage']))
